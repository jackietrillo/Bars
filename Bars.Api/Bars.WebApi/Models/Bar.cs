namespace Bars.WebApi.Models
{
    public class Bar
    {
        ...
        private readonly bool _statusFlag;
        public bool StatusFlag { get { return _statusFlag; } }

        public Bar(string name, string description, string addresss, string phone, string hours, decimal latitude, decimal longitude, string websiteUrl,
